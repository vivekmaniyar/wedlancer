...
import com.rd.wedlancerfreelancer.Adapter.BookingAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnreview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MydashboardActivity.this, ReviewActivity.class).putExtra("username", username));
            }
        });
        //dialog.show();//progressdialog
        //API
        StringRequest str = new StringRequest(Request.Method.GET, "https://wedlancer.azurewebsites.net/api/Profiles/freelancerbookings?username=" + username, response -> {
