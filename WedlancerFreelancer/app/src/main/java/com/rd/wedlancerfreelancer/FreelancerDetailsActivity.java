...
import com.rd.wedlancerfreelancer.Adapter.VideoAdapter;
...
public class FreelancerDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        }, error -> Toast.makeText(FreelancerDetailsActivity.this, "" + error.getMessage(), Toast.LENGTH_SHORT).show());
        ...
        btnreview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FreelancerDetailsActivity.this, ReviewActivity.class);
